...
class ViewController: UIViewController, MPMediaPickerControllerDelegate
{
    ...
    func timerFired(_:AnyObject)
    {
        ...
        if let currentTrack = MPMusicPlayerController.systemMusicPlayer().nowPlayingItem
        {
            ...
            if(loopingSongBackground == false)
            {
                ...
                if trackElapsedSeconds < 10 && trackElapsedMinutes < 10
                {
                    timeElapsed.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds)"
                }
                else if trackElapsedSeconds > 10 && trackElapsedMinutes < 10
                {
                    timeElapsed.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds)"
                }
                else if trackElapsedSeconds < 10 && trackElapsedMinutes > 10
                {
                ...
                if trackRemainingSeconds < 10 && trackRemainingMinutes < 10
                {
                    timeRemaining.text = "0\(trackRemainingMinutes):0\(trackRemainingSeconds)"
                }
                else if trackRemainingSeconds > 10 && trackRemainingMinutes < 10
                {
                    timeRemaining.text = "0\(trackRemainingMinutes):\(trackRemainingSeconds)"
                }
                else if trackRemainingSeconds < 10 && trackRemainingMinutes > 10
                {
    ...
    if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100
    {
        timeDuration.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100
    {
        timeDuration.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes < 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100
    {
        timeDuration.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes > 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100
    {
        timeDuration.text = "\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    }
    

    else if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
    {
        timeDuration.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 100
    {
        timeDuration.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 100
    {
        timeDuration.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
    ...
    else if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 10
    {
        timeDuration.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 10 && trackElapsedMilliseconds < 100
    {
        timeDuration.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 10 && trackElapsedMilliseconds < 100
    ...
    {
        timeDuration.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
    }
    ...
    {
        timeDuration.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
    }
    ...
    {
        timeDuration.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
    }
    else if trackElapsedMinutes < 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
    {
        timeDuration.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
                ...
                // just change the loopLeft.text and loopRight.text
            {
                ...
                //Find remaining time by subtraction the elapsed time from the duration
                if time1ElapsedMinutes < 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100
                {
                    loopLeft.text = "\(time1ElapsedMinutes):0\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds > 10 && time1ElapsedMilliseconds < 100
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds > 10 && time1ElapsedMilliseconds < 100
                {
                    loopLeft.text = "\(time1ElapsedMinutes):\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                    
                    
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100 && time1ElapsedMilliseconds > 10
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds > 100
                {
                    loopLeft.text = "\(time1ElapsedMinutes):0\(time1ElapsedSeconds):\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100 && time1ElapsedMilliseconds > 10
                ...
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 10
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):00\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds > 10 && time1ElapsedMilliseconds < 100
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopLeft.text = "\(time1ElapsedMinutes):0\(time1ElapsedSeconds):00\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):\(time1ElapsedSeconds):00\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopLeft.text = "0\(time1ElapsedMinutes):\(time1ElapsedSeconds):\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds > 10 && time1ElapsedMilliseconds < 100 && time1ElapsedMilliseconds > 10
                {
            ...
            if (loopRightChanging == true)
            {
                ...
                if time1ElapsedMinutes < 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100
                {
                    loopRight.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100
                {
                    loopRight.text = "\(time1ElapsedMinutes):0\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds > 10 && time1ElapsedMilliseconds < 100
                {
                    loopRight.text = "0\(time1ElapsedMinutes):\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds > 10 && time1ElapsedMilliseconds < 100
                {
                    loopRight.text = "\(time1ElapsedMinutes):\(time1ElapsedSeconds):0\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopRight.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds > 100
                {
                    loopRight.text = "\(time1ElapsedMinutes):0\(time1ElapsedSeconds):\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes > 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds < 100 && time1ElapsedMilliseconds > 10
                ...
                {
                    loopRight.text = "0\(time1ElapsedMinutes):0\(time1ElapsedSeconds):00\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds < 10 && time1ElapsedMilliseconds > 10 && time1ElapsedMilliseconds < 100
                {
                ...
                {
                    loopRight.text = "\(time1ElapsedMinutes):0\(time1ElapsedSeconds):00\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopRight.text = "0\(time1ElapsedMinutes):\(time1ElapsedSeconds):00\(time1ElapsedMilliseconds)"
                    loop()
                }
                ...
                {
                    loopRight.text = "0\(time1ElapsedMinutes):\(time1ElapsedSeconds):\(time1ElapsedMilliseconds)"
                    loop()
                }
                else if time1ElapsedMinutes < 10 && time1ElapsedSeconds > 10 && time1ElapsedMilliseconds < 100 && time1ElapsedMilliseconds > 10
                {
        ...
        else
        {
            if playLoopedbutton.currentImage == UIImage(named:"ic_action_playsong.png")
            {
                ...
                if (isBackgroundPlayerPlaying == false)
                {
                    ...
                    if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100
                    {
                        loopLeft.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes < 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes > 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100
                    {
                        loopLeft.text = "\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
                    }
                    ...
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 100
                    {
                        loopLeft.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
                    ...
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 10 && trackElapsedMilliseconds < 100
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
                    ...
                    {
                        loopLeft.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
                    }
                    ...
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
                    }
                    ...
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
                    }
                    else if trackElapsedMinutes < 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
                    {
                        loopLeft.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
    ...
    func secondsToTimeRightLoop(seconds : Double)
    {
        ...
        if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100
        {
            loopRight.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100
        {
            loopRight.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes < 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100
        {
            loopRight.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes > 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100
        {
            loopRight.text = "\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
        }
        ...
        {
            loopRight.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 100
        {
            loopRight.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes > 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
        ...
        {
            loopRight.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes < 10 && trackElapsedSeconds < 10 && trackElapsedMilliseconds > 10 && trackElapsedMilliseconds < 100
        {
            loopRight.text = "0\(trackElapsedMinutes):0\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
        ...
        {
            loopRight.text = "\(trackElapsedMinutes):0\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
        }
        ...
        {
            loopRight.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):00\(trackElapsedMilliseconds)"
        }
        ...
        {
            loopRight.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):\(trackElapsedMilliseconds)"
        }
        else if trackElapsedMinutes < 10 && trackElapsedSeconds > 10 && trackElapsedMilliseconds < 100 && trackElapsedMilliseconds > 10
        {
            loopRight.text = "0\(trackElapsedMinutes):\(trackElapsedSeconds):0\(trackElapsedMilliseconds)"
