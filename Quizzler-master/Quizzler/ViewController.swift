...
class ViewController: UIViewController
{
    ...
    func nextQuestion()
    {
        ...
        {
            let alert = UIAlertController(title: "Awesome", message: "You've finished all questions, do you wanna start over?", preferredStyle: .alert)
    ...
    func checkAnswer()
    {
        if pickedAnswer == allQuestions.list[questionNumber].answers
        {
